...
{ public World World { get; } = world; public bool Cancelled { get; set; } }
...
public class PlayerRespawnEventArgs(PlayerEntity player, World world, bool reset, bool fromLogoff) : PlayerEventArgs(player)
{
    ...
    public bool FromLogoff { get; set; } = fromLogoff;
    public World World { get; } = world;
    public bool Cancelled { get; set; }
}

public class PlayerTeleportEventArgs(PlayerEntity player, Vector3 oldPosition, Vector3 destination) : PlayerEventArgs(player)
{
...
{ public bool IgnoreGrounded { get; } = ignoreGrounded; public bool Cancelled { get; set; } }

public class PlayerTickEventArgs(PlayerEntity player, Chunk chunk, World world) : PlayerEventArgs(player)
{ public Chunk Chunk { get; } = chunk; public World World { get; } = world; }
...
{ public Item Item { get; } = item; public bool IsLeftClick { get; } = isLeftClick; public World World { get; } = world; public bool Cancelled { get; set; } }
...
public class PlayerAttackEntityEventArgs(PlayerEntity player, Entity target, World world) : PlayerEventArgs(player)
{
    ...
    public World World { get; } = world;
    public int AttackDelay { get; internal set; } = -1;
    public bool Cancelled { get; set; }
}
...
{ public Vector3i Position { get; } = position; public Block Block { get; } = block; public World World { get; } = world; public bool Cancelled { get; set; } }
...
{ public ItemStack Stack { get; } = stack; public World World { get; } = world; public bool Cancelled { get; set; } }

public class PlayerStaminaConsumeEventArgs(PlayerEntity player, int amount, int oldStamina, int maxStamina) : PlayerEventArgs(player)
{
    public int Amount { get; set; } = amount;
    public int OldStamina { get; } = oldStamina;
    public int NewStamina { get; internal set; } = oldStamina;
    public int MaxStamina { get; } = maxStamina;
    public bool Success { get; internal set; }
    public bool Cancelled { get; set; }
}

public class PlayerSneakEventArgs(PlayerEntity player, bool sneaking) : PlayerEventArgs(player) { public bool Sneaking { get; } = sneaking; }
public class PlayerNoclipEventArgs(PlayerEntity player, bool noclip) : PlayerEventArgs(player) { public bool Noclip { get; } = noclip; }
public class PlayerGlideEventArgs(PlayerEntity player, bool gliding) : PlayerEventArgs(player) { public bool Gliding { get; } = gliding; }
public class PlayerFlyEventArgs(PlayerEntity player, bool flying) : PlayerEventArgs(player) { public bool Flying { get; } = flying; }
public class PlayerBlockingEventArgs(PlayerEntity player, bool blocking) : PlayerEventArgs(player) { public bool Blocking { get; } = blocking; }
...
{ public int OldStamina { get; } = oldStamina; public int NewStamina { get; } = newStamina; public int MaxStamina { get; } = maxStamina; }